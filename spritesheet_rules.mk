...
$(OBJEVENTGFXDIR)/people/secondary_characters/chano.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/secondary_characters/girl_pink_hair.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/secondary_characters/little_boy_brown.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/secondary_characters/little_girl_brown.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/secondary_characters/old_people.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/secondary_characters/roger.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
